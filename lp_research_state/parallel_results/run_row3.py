...
OUT = "/sessions/keen-magical-meitner/mnt/Erdos/lp_research_state/parallel_results/row3_bochner.json"

PARAMS = dict(h1=0.020, h2=0.020, p1=0.375, p2=0.375, q1=-0.02, q2=0.02,
              bochner_n=20, R=10, solver="CLARABEL")

fallback_chain = []
result = None
for N, T in [(10000, 4000), (5000, 2000), (3000, 1200)]:
    ...
    try:
        ...
        if res["status"] in ("optimal", "optimal_inaccurate") and res["value"] is not None:
            result = {
                "row": "row3", "N": N, "T": T, "R": 10, "bochner_n": 20,
...
if result is None:
    result = {"row": "row3", "N": None, "T": None, "R": 10, "bochner_n": 20,
