...
OUT = "/sessions/keen-magical-meitner/mnt/Erdos/lp_research_state/parallel_results/row1_bochner.json"

PARAMS = dict(h1=0.015, h2=0.015, p1=0.381, p2=0.381, q1=-0.02, q2=0.02,
              bochner_n=20, R=10, solver="CLARABEL")

fallback_chain = []
result = None
for N, T in [(10000, 4000), (10000, 3000), (5000, 4000), (5000, 2000), (3000, 4000), (3000, 2000)]:
    ...
    try:
        ...
        if res["status"] in ("optimal", "optimal_inaccurate") and res["value"] is not None:
            result = {
                "row": "row1", "N": N, "T": T, "R": 10, "bochner_n": 20,
...
if result is None:
    result = {"row": "row1", "N": None, "T": None, "R": 10, "bochner_n": 20,
