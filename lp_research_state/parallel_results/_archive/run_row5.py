...
OUT = "/sessions/keen-magical-meitner/mnt/Erdos/lp_research_state/parallel_results/row5_bochner.json"

# row5: (h, p, q1, q2) = (0.000, 0.4, -0.02, 0.02)
PARAMS = dict(h1=0.0, h2=0.0, p1=0.4, p2=0.4, q1=-0.02, q2=0.02,
              bochner_n=20, R=10, solver="CLARABEL")

fallback_chain = []
result = None
for N, T in [(1700, 680), (1500, 600)]:
    ...
    try:
        ...
        if res["status"] in ("optimal", "optimal_inaccurate") and res["value"] is not None:
            result = {
                "row": "row5", "N": N, "T": T, "R": 10, "bochner_n": 20,
...
if result is None:
    result = {"row": "row5", "N": None, "T": None, "R": 10, "bochner_n": 20,
