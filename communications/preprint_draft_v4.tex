...
Separately we certify $\mu \le 0.380859056614806899090596051448$ in
...
$\mu \le 0.380859056614806899090596051448$, certified in exact rational
arithmetic.
\end{theorem}
...
sub-box, drives $\varepsilon$ to $2.5\times10^{-8}$ and recovers it.
The subdivision is reported with its grid resolution because the two
interact: at $801$ points per axis and depth $20$ the residual-region
floor is $0.3803953504$, but at $401$ points it under-resolves to
$0.3803953255$.
...
$(h,p) = (0.0024773, 0.3924336)$, with grid minimum $0.3803953754$ --- so
this convention is within $2.5\times10^{-8}$ of everything it can give,
and the residual region is not where slack remains. The remaining
regions give $0.3803961$, $0.3803979$, $0.3804045$, $0.3804601$ and
$0.3805539$, all above it, so the residual region binds and
Theorem~\ref{thm:main} follows. Margins on the three tightest are
$+7.5\times10^{-7}$, $+2.6\times10^{-6}$ and $+9.2\times10^{-6}$: any
future gain on the residual region will meet them immediately.
