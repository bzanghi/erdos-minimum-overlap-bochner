...
The wild investigations produced **two genuinely actionable new directions** (one strong, one publishable-negative) and **two clean confirmations** of the diagnostic's conclusion.

| # | Investigation | Outcome |
|---|---|---|
| 1 | Cross-domain analogy hunt | **Strong new lead**: arXiv:2210.16437 (White's own L² autoconvolution) + arXiv:2206.09876 (Cohn-de Laat-Salmon) |
...
## The strong lead — Lever H: transfer White's L² autoconvolution machinery
...
## Updated lever ledger (10 levers, 8 ruled out)
...
| **H — White's L² autoconvolution transfer** | **🟡 untested, strong lead** | [arXiv:2210.16437](https://arxiv.org/abs/2210.16437) — uniqueness/eigenvalue tech |
| **I — Cohn-de Laat-Salmon saturation theorem** | **🟡 untested, publishable** | [arXiv:2206.09876](https://arxiv.org/abs/2206.09876) — proves duality gaps |

## Recommended next steps, prioritized

### Action 1 (low-effort, high-information): Email Ethan White

Adapt [communications/email_to_ethan_white.md](communications/email_to_ethan_white.md) to include both:
- The CDE Phase 5 result and the diagnostic findings
- A specific question about whether the L² autoconvolution uniqueness machinery from arXiv:2210.16437 applies to min-overlap

White is the author of both papers and the natural arbiter. Estimated effort: 1-2 hours. Estimated decision value: maybe months saved on a wrong direction, or a confirmed lever.

### Action 2 (medium-effort, methodologically valuable): Read arXiv:2210.16437 carefully

Section-by-section read of White's L² autoconvolution paper, focused on:
- The variational structure (what makes the L² problem "almost tight")
- The uniqueness argument (second-variation positivity)
- Whether the same operator framework can be defined for min-overlap

Estimated effort: 4-8 hours of close reading + a structured memo. Estimated decision value: definitive verdict on Lever H without code.

### Action 3 (medium-effort, publishable): Investigate Cohn-de Laat-Salmon for a duality-gap theorem

Read arXiv:2206.09876 §§2-4 and see whether the discrete-reduction duality machinery can be applied to White's program. Even a negative answer ("it doesn't apply because X") is publishable in the methodological note.

Estimated effort: 1-2 days. Estimated decision value: a theorem on the Phase 5 ceiling, or a clean ruling-out.

### Action 4 (trivial, formal completeness): Close the T5p gap

Thread `use_T5p` through `path_b_analytical.build_problem_with_dual_handles` and re-run Phase 5. Expected gain ≤ +5 × 10⁻⁶. Estimated effort: 1 hour. Worth doing for formal completeness of the negative-result memo.

### Action 5 (write-up): Add SAT extension to the preprint

The SAT-extended M(19), M(20) values are novel data deserving inclusion in any writeup, with the caveat that they don't change the µ bound. Estimated effort: 30 min in the preprint.
